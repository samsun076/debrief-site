...
Public landing site for **Debrief** (`debrief.run`) — the product lives in `../debrief`
(private repo `samsun076/debrief`).
...
`../debrief/docs/decisions/2026-07-21-rebrand-debrief.md`.
